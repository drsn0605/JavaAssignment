...
<hr>
${msg }
<form action="edit14" method="post">
<input type="hidden" name="id" value="${stdata.id }">
<input type="text" name="uname" placeholder="Enter your name" class="form-control" value="${stdata.name }">
<br>
...
<a href="display14" class="btn btn-warning">Display</a>
