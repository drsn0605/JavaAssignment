...
public class ProductController {
	...
	@PostMapping("/")
	public ResponseEntity<ProductDto> create(@RequestBody ProductDto dto, @RequestParam("category") Long id) {
		CategoryDto cat = catservice.retrive(id);
		dto.setCategory(cat);
	...
	@PutMapping("/{id}")
	public ResponseEntity<ProductDto> update(@RequestBody ProductDto dto, @PathVariable("id") Long id, @RequestParam("cid") Long cid) {
