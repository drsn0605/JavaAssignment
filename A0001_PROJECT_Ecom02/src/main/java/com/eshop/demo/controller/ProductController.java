...
public class ProductController {
	...
	@PostMapping("/{id}")
	public ResponseEntity<ProductDto> create(@RequestBody ProductDto dto, @PathVariable("id") Long cid) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ProductDto> update(@RequestBody ProductDto dto, @PathVariable("id") Long pid, @RequestParam("cat") Long cid) {
		CategoryDto c = cservice.retrive(cid);
		dto.setCategory(c);
